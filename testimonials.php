...
if(isset($_REQUEST['del']))
	{
$delid=intval($_GET['del']);
$sql1="SELECT * from tbltestimonial WHERE id=:delid";
...
$sql = "INSERT INTO  deleted_feedback(ip,UserEmail,Testimonial,PostingDate) VALUES(:ip,:email,:testimonial,:postingdate)";
$query1 = $dbh->prepare($sql);
$query1 -> bindParam(':ip',$ip, PDO::PARAM_STR);
$query1 -> bindParam(':email',$email, PDO::PARAM_STR);
$query1 -> bindParam(':testimonial',$testimonial, PDO::PARAM_STR);
$query1 -> bindParam(':postingdate',$postingdate, PDO::PARAM_STR);
$query1 -> execute();
}
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT tblusers.FullName,tbltestimonial.ip,tbltestimonial.UserEmail,tbltestimonial.Testimonial,tbltestimonial.PostingDate,tbltestimonial.status,tbltestimonial.id from tbltestimonial join tblusers on tblusers.Emailid=tbltestimonial.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<a href="testimonials.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
<?php } else {?>
