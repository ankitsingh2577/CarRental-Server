...
<head>
	...
	<title>Wheels on Rent | New Bookings   </title>
...
{				?>	
	<h3 style="text-align:center; color:red; font-weight: bolder;">#<?php echo htmlentities($result->BookingNumber);?> Booking Details </h3>
