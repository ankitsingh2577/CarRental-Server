...
<head>
	...
	<title>Wheels on Rent | Admin Dashboard</title>
...
?>
											...
											<a href="mannage-booking.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php 
$sql4 ="SELECT ip from deleted_feedback";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Block IP</div>
												</div>
											</div>
											<a href="deleted-feedback.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
